...
export const CANONICAL_ARCHITECTURE_INVENTORY: CanonicalRegistryRecord[] = [
  ...
  { id: 'integration.google-drive', kind: 'integration', name: 'Google Drive', lifecycle: 'active', verification: 'DECLARED', health: 'UNKNOWN', dataClassification: 'RESTRICTED', description: 'Document/file source for knowledge ingestion.', capabilities: ['drive.read', 'drive.search'], evidence: contextEvidence('integration:google-drive') },
  { id: 'integration.clickup', kind: 'integration', name: 'ClickUp', lifecycle: 'planned', verification: 'DECLARED', health: 'UNKNOWN', dataClassification: 'INTERNAL', description: 'Target human-facing mission-control and operational work-management surface.', capabilities: ['tasks.read', 'tasks.write', 'workflow.events'], evidence: contextEvidence('integration:clickup') },
  { id: 'integration.wisebase', kind: 'integration', name: 'AI Wisebase', lifecycle: 'active', verification: 'DECLARED', health: 'UNKNOWN', dataClassification: 'RESTRICTED', description: 'Durable knowledge and semantic-memory surface.', capabilities: ['knowledge.search', 'knowledge.store'], evidence: contextEvidence('integration:wisebase') },
